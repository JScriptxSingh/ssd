...
$("#toggleView").on("click", function (event) {
    $('.schedule').toggleClass("list");
    if (isList) {
        isList = false;
        $("#toggleView").html("<i class='fas fa-th-list'></i> List View");
    } else {
        isList = true;
        $("#toggleView").html("<i class='fas fa-grip-horizontal'></i> Grid View");
    }
});

$( document ).ready(function() {
    var today = $.format.date(new Date(), "MMMM d, yyyy");
...
$("#goToToday").on("click", function (event) {
